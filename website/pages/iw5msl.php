...
$serverlist_file =
	...
	: ROOT . "/../../iw5msl/serverinfo.txt"
	;

if(!file_exists($serverlist_file))
{ ?>
<p>The server list is currently being changed due to some upgrades and therefore not available. Sorry for any inconvenience.</p>
<? } else {
...
{
	global $_GAMETYPES;
	if(empty($_GAMETYPES["iw5m"][$gt]))
		return $gt;
	else
		return $_GAMETYPES["iw5m"][$gt];
}
